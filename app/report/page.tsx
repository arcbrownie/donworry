...
const GOOGLE_FORM_URL = "https://forms.gle/PnyN5scfYyKymg1h6";
        ...
        <div className="container">
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-5 md:p-6 shadow-sm max-w-3xl">
            <p className="text-muted-foreground leading-relaxed">
              돈워리(donworry.kr)의 정확한 정보를 위해 도움을 주세요! 소중한 의견을 남겨주신 분들 중
              매달 3분을 선정하여 스타벅스 기프티콘을 보내드립니다. ☕
            </p>
          </div>
        </div>
      </section>
