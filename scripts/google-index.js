...
const urlsToIndex = [
  'https://donworry.kr/',
  'https://donworry.kr/about',
  'https://donworry.kr/blog/credit-card-vs-check-card',
  'https://donworry.kr/blog/first-loan-guide-2030',
  'https://donworry.kr/blog/investment-guide-for-beginners',
  'https://donworry.kr/blog/one-person-household-savings',
  'https://donworry.kr/blog/personal-rehabilitation-2026',
  'https://donworry.kr/blog/social-beginner-salary-guide',
  'https://donworry.kr/blog/weekly-holiday-pay-guide',
];
...
async function main() {
  console.log('\n');
  log(`${emoji.rocket} Google Indexing API 스크립트 시작`, 'bright', '');
  printSeparator();
  ...
  log(`총 ${urlsToIndex.length}개의 URL 색인 요청 시작`, 'blue', emoji.info);
  printSeparator();
