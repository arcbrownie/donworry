...
import { collectFAQsFromContents, mergeFAQs } from "@/lib/faq-extractor";
import type { FAQItem } from "@/lib/faq-extractor";

// 블로그 콘텐츠에서 FAQ import
import { faqs as personalRehabFAQs } from "@/pages/content/PersonalRehabilitation2026";
...
const blogContentFAQs = [
  { faqs: personalRehabFAQs }
];

// FAQ 병합 (블로그 FAQ + 기본 FAQ)
const debtFAQ = mergeFAQs(
